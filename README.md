...
Luke enjoys academic research, believing that prior proper planning, due diligence, and a thorough understanding of risks is necessary to help architect and realise the Web3 vision, similar to testing code for vulnerabilities. He wishes to realise the vision of this initiative spawned at EthBerlin04 and believes support from JUST Open Source Stiftung will help.

He believes academic research toward achieving its vision will enhance how each of the JUST Open Source Stiftung principles are adopted and that providing automated support tools will help individuals and collectives focus on Web3 promises.
...
* Market forces, drivers, and trends
	* Cross-chain analytical market research into the impact on adoption that may be caused by the behaviour of entities that are misaligned and non-compliant with their manifestos and potential ways to improve and the extent of improvement that could be possible by detecting and rectifying the misalignment and non-compliance 
* Open-source communities
	* Research open-source ways that collectives may successfully manage and reform entities that are misaligned and non-compliant with their manifestos, specifically with open-source requirements, and that have been grouped into decentralized collectives with shared ownership 
* Identity
	* Research ways to manage the extent of misalignment and non-compliance of entities with their manifestos securely and privately on the blockchain to allow those entities to access and control and improve upon their own data and reputation
...
* Credit from adoption of the theoretical research by other Web3 researchers or open-source Web3 software implementers
...
Whilst not the focus of the academic research grant, our academic research findings could drive the following future implementations:
...
* Create of a multisignature research account on one or more Web3 decentralised software platforms
* Creation of a research account on Web2 social media platforms (e.g. https://grillapp.net/@luke) to migrate the audience to Web3 decentralised software platforms (e.g. Joystream)
* Publish at least monthly theoretical research progress reports on the Web2 social media platforms and Web3 decentralized software platforms
...
The project research will touch on all the focus areas.

#### Assumptions

Theoretical research exploration only
...
Plans to achieve our research objectives include:
...
* Aug 2024 - Oct 2024
	...
	* Creation of formal problem specifications
	* Design of algorithm theories to design algorithms from the formal problem specifications.
	* Research journals and scientific studies
	* Optioneering
	* Publish theoretical research progress reports at least monthly on the Web2 social media platforms and Web3 decentralized software platforms
	* Publish detailed theoretical research progress reports on at least a quarterly basis that shall also mention the level of:
		* Improvement in the Web3 audience to demonstrate Web3 adoption by verified identities
	* Case study interviews and publication of work snippets on JUST Open Source Stiftung channels.
...
* Nov 2024 - Jan 2025
	* Research journals and scientific studies
	* Optioneering
	* Publish theoretical research progress reports
	* Publish detailed theoretical research progress reports
	* Case study interviews and publication of work snippets on JUST Open Source Stiftung channels.
...
Monthly budgeet breakdown:

* Aug 2024 - Oct 2024 - €5,000
* Nov 2024 - Jan 2025 - €5,000
* Feb 2025 - Apr 2025 - €5,000
* May 2025 - July 2025 - €5,000

Total requested amount: €20,000

Note:
* Software and hardware costs are already minimised since both Luke Schoen and Sven Buschbeck already each have a performant hardware.
...
Below we have compiled our previous research background as a academics even if not directly relevant to the proposed project (samples, github, published materials, awards):
...
* 2020 Research LoRaWAN and Polkadot to prepare DataHighway Whitepaper, MXC Foundation gGmbH, https://github.com/DataHighway-DHX/documentation/blob/master/static/whitepapers/economic/whitepaper_v1_2_0.pdf
